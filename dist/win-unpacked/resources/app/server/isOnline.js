const isOnline = async () => {
    ...
    for (let dir = 0; dir < strArr.length; dir++) {
        try {
            ...
            let fileToCheck = __dirname.substring(0, __dirname.lastIndexOf('resources')) + winPath
            // console.log(fileToCheck)
            if (fs.existsSync(fileToCheck) === false) {
                let folder = fileToCheck.substring(0, fileToCheck.lastIndexOf('\\'))
                // console.log(fileToCheck, '111111111111111', folder)
